                ...
                gpointer       user_data)
{
  ...
  //FIXME second parameter should be the app's window, not NULL
  GtkWidget *dialog = gtk_file_chooser_dialog_new ("Save File (test)", NULL,
	...
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Plain Text"), ".txt");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Portable Document Format"), ".pdf");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("PostScript Document"), ".ps");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Top Secret Format v1"), ".tsf");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Top Secret Format v2"), ".tsf");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Top Secret Format Extended"), ".tsfx");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Vectorized Image"), ".svg");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Mobile SVG"), ".svgt");
	gtk_file_chooser_add_extension (GTK_FILE_CHOOSER (dialog), ("Vector Markup Language"), ".vml");

  gtk_file_chooser_set_current_name (GTK_FILE_CHOOSER (dialog), "Bloated File");

	if (gtk_file_chooser_set_current_extension_full (GTK_FILE_CHOOSER (dialog), ("Portable Document Format"), ".pdf"))
    printf ("Currently selected .pdf\n");

  gtk_file_chooser_set_force_valid_extension (GTK_FILE_CHOOSER (dialog), TRUE);
...
about_activated (GSimpleAction *action,
                 ...
                 gpointer       user_data)
{
  //FIXME first parameter should be the app's window, not NULL
